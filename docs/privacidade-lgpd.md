...
ANP: Instalações do SIMP segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [anp_instalacoes_simp@mcp.ai](mailto:anp_instalacoes_simp@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
